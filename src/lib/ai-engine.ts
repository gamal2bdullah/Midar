...
const DIMENSIONS = {
  ...
  impact: ["أثر", "نتيجة", "تغيير", "تحسين", "مستقبل", "حل", "تأثير", "استدامة", "نمو", "فائدة", "مستدام", "مجتمع", "رعاية", "كفاءة"],
  empathy: ["مستخدم", "أشخاص", "مريض", "طالب", "موظف", "معاناة", "شعور", "يحتاج", "يواجه", "إنسان", "متضرر", "طبيب", "نفسي"],
...
export function classifyContrast(critique: string): string {
  ...
  if (kws.some(k => ["غالي", "مال", "ميزانية", "سعر", "تكلفة", "مبلغ"].includes(k))) return 'عائق مالي';
